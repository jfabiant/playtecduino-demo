...
Blockly.Arduino.init = function(a) {
    ...
    var b = [];
    a = Blockly.Variables.allVariablesAndTypes(a);
    for (var c = {
            Number: "int",
            Long: "long",
            Float: "float",
            ...
            String: "String",
            Array: "int",
            Volatile_Int: "volatile int",
            Word: "word",
            Double: "double",
            Unsigned_Int: "unsigned int",
            Unsigned_Long: "unsigned long"
        }, d = 0; d < a.length; d++) b[d] = "" == a[d][1] ? "int  " + a[d][0] + ";\n" : c[a[d][1]] + " " + a[d][0] + ";\n", Blockly.Arduino.definitions_[a[d][0]] = b[d]
};
...
Blockly.Arduino.controls_whileUntil = function(a) {
    var b = "UNTIL" == a.getFieldValue("MODE"),
        c = Blockly.Arduino.valueToCode(a, "BOOL", Blockly.Arduino.ORDER_NONE) || "false",
        d = Blockly.Arduino.statementToCode(a, "DO");
    d = Blockly.Arduino.addLoopTrap(d, a.id);
    b && (c = "!" + c);
    return "while (" + c + ") {\n" + d + "}\n"
};
Blockly.Arduino.controls_while = function(a) {
...
Blockly.Arduino.controls_return = function(a) {
    return "return " + (Blockly.Arduino.valueToCode(a, "VAL", Blockly.Arduino.ORDER_NONE) || "") + ";\n"
};
Blockly.Arduino.involt = {};
Blockly.Arduino.involt_directmode = function() {
    var a = "TRUE" == this.getFieldValue("BOOL") ? "true" : "false";
    Blockly.Arduino.definitions_.define_directmode = "boolean directMode = " + a + ";\n";
    return ""
};
...
Blockly.Arduino.variables_set = function(a) {
    ...
    a = Blockly.Variables.allVariablesAndTypes(this.workspace);
...
Blockly.Arduino.i2c_sevenseg_begin = function() {
    ...
    Blockly.Arduino.setups_["setup_sevenseg_" + a] = "sevenseg.begin(" + a + ");";
    return ""
};
Blockly.Arduino.i2c_sevenseg_print = function() {
    var a = Blockly.Arduino.valueToCode(this, "NUM", Blockly.Arduino.ORDER_ATOMIC) || "7777";
    9999 < a ? a = 9999 : 0 > a && (a = 1);
    return "sevenseg.print(" + a + ");\n"
};
Blockly.Arduino.i2c_sevenseg_writedisplay = function() {
    return "sevenseg.writeDisplay();\n"
};
Blockly.Arduino.i2c_sevenseg_writedigitnum = function() {
    var a = Blockly.Arduino.valueToCode(this, "POSITION", Blockly.Arduino.ORDER_ATOMIC) || "0",
        b = Blockly.Arduino.valueToCode(this, "NUM", Blockly.Arduino.ORDER_ATOMIC) || "0",
        c = Blockly.Arduino.valueToCode(this, "DOTS", Blockly.Arduino.ORDER_NONE) || "false";
    9 < b && (b = 9);
    return "sevenseg.writeDigitNum(" + a + "," + b + "," + c + ");\n"
};
Blockly.Arduino.i2c_sevenseg_drawcolon = function() {
    return "sevenseg.drawColon(" + (Blockly.Arduino.valueToCode(this, "DOTS", Blockly.Arduino.ORDER_NONE) || "false") + ");\n"
};
...
Blockly.Arduino.delay = function() {
    return "delay(" + this.getFieldValue("DELAY_TIME") + ");\n"
};
...
Blockly.Arduino.delayMicroseconds_custom = function() {
    return "delayMicroseconds(" + (Blockly.Arduino.valueToCode(this, "DELAY_TIME", Blockly.Arduino.ORDER_ATOMIC) || "1000") + ");\n"
};
Blockly.Arduino.delayMicroseconds = function() {
    return "delayMicroseconds(" + this.getFieldValue("DELAY_TIME") + ");\n"
};
...
Blockly.Arduino.grove_touch = function() {
    var a = this.getFieldValue("PIN");
    Blockly.Arduino.setups_["setup_touch_" + a] = "pinMode(" + a + ", INPUT);";
    return ["digitalRead(" + a + ")", Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Arduino.grove_thumb_joystick = function() {
    var a = this.getFieldValue("PIN");
    return ["analogRead(" + ("y" === this.getFieldValue("AXIS") ? _get_next_pin(a) : a) + ")", Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Arduino.grove_rgb_led = function() {
    ...
    for (var c = 0; c < this.itemCount_; c++) {
        ...
        b += "DataDealWithAndSend_" + a + "(" + hexToR(d) + ", " + hexToG(d) + ", " + hexToB(d) + "); // first node data\n"
    }
...
Blockly.Arduino.grove_rgb_lcd_setcolor = function() {
    ...
    var a = this.getFieldValue("RGB");
    return "grove_lcd.setRGB(" + hexToR(a) + ", " + hexToG(a) + ", " + hexToB(a) + ");\n"
};
Blockly.Arduino.grove_rgb_lcd_begin = function() {
    var a = this.getFieldValue("COLS"),
        b = this.getFieldValue("ROWS");
    Blockly.Arduino.definitions_.define_wire = "#include <Wire.h>\n";
    Blockly.Arduino.definitions_.define_rgb_lcd = '#include "rgb_lcd.h"\nrgb_lcd grove_lcd;\n';
    return "grove_lcd.begin(" + a + "," + b + ");\n"
};
Blockly.Arduino.grove_rgb_lcd_print = function() {
    var a = Blockly.Arduino.valueToCode(this, "PRINT", Blockly.Arduino.ORDER_NONE);
    Blockly.Arduino.definitions_.define_wire = "#include <Wire.h>\n";
    Blockly.Arduino.definitions_.define_rgb_lcd = '#include "rgb_lcd.h"\nrgb_lcd grove_lcd;\n';
...
Blockly.Arduino.grove_rgb_lcd_custom_setcursor = function() {
    var a = Blockly.Arduino.valueToCode(this, "COL", Blockly.Arduino.ORDER_NONE) || "0",
        b = Blockly.Arduino.valueToCode(this, "ROW", Blockly.Arduino.ORDER_NONE) || "0";
    Blockly.Arduino.definitions_.define_wire = "#include <Wire.h>\n";
    Blockly.Arduino.definitions_.define_rgb_lcd = '#include "rgb_lcd.h"\nrgb_lcd grove_lcd;\n';
    return "grove_lcd.setCursor(" + a + "," + b + ");\n"
};
...
Blockly.Arduino.grove_ir_receiver_check_data = function() {
    return ["IR.IsDta()", Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Arduino.grove_ir_emitter_send = function() {
    var a = Blockly.Arduino.valueToCode(this, "DATA", Blockly.Arduino.ORDER_NONE) || 0;
    0 > a ? a = 0 : 255 < a && (a = 255);
    Blockly.Arduino.definitions_.define_irsendrev = "#include <IRSendRev.h>\n";
...
Blockly.Arduino.grove_led_bar = function() {
    var a = this.getFieldValue("PIN"),
        b = _get_next_pin(a),
        c = Blockly.Arduino.valueToCode(this, "LEVEL", Blockly.Arduino.ORDER_ATOMIC) || 0;
...
Blockly.Arduino.i2c_matrix_begin = function() {
    ...
    Blockly.Arduino.setups_["setup_" + b + "_" + a] = "matrix.begin(" + a + ");";
    return ""
};
...
Blockly.Arduino.i2c_matrix_setcursor = function() {
    var a = Blockly.Arduino.valueToCode(this, "COL", Blockly.Arduino.ORDER_ATOMIC) || "0",
        b = Blockly.Arduino.valueToCode(this, "ROW", Blockly.Arduino.ORDER_ATOMIC) || "0";
    return "matrix.setCursor(" + a + "," + b + ");\n"
};
Blockly.Arduino.i2c_matrix_print = function() {
    return "matrix.print(" + (Blockly.Arduino.valueToCode(this, "CONTENT", Blockly.Arduino.ORDER_ATOMIC) || "") + ");\n"
};
Blockly.Arduino.i2c_matrix_settextsize = function() {
    return "matrix.setTextSize(" + this.getFieldValue("SIZE") + ");\n"
};
Blockly.Arduino.i2c_matrix_settextcolor = function() {
    return "matrix.setTextColor(" + this.getFieldValue("COLOR") + ");\n"
};
Blockly.Arduino.i2c_matrix_settextwrap = function() {
    return "matrix.setTextWrap(" + ("TRUE" == this.getFieldValue("BOOL") ? "true" : "false") + ");\n"
};
Blockly.Arduino.i2c_matrix_drawpixel = function() {
    ...
    return "matrix.drawPixel(" + a + "," + b + "," + c + ");\n"
};
Blockly.Arduino.i2c_matrix_drawcircle = function() {
    var a = Blockly.Arduino.valueToCode(this, "X", Blockly.Arduino.ORDER_ATOMIC) || "0",
        b = Blockly.Arduino.valueToCode(this, "Y", Blockly.Arduino.ORDER_ATOMIC) || "0",
        c = Blockly.Arduino.valueToCode(this, "D", Blockly.Arduino.ORDER_ATOMIC) || "0",
        d = this.getFieldValue("COLOR");
    return "matrix.drawCircle(" + a + "," + b + "," + c + "," + d + ");\n"
};
Blockly.Arduino.i2c_matrix_drawrect = function() {
    var a = Blockly.Arduino.valueToCode(this, "X0", Blockly.Arduino.ORDER_ATOMIC) || "0",
        b = Blockly.Arduino.valueToCode(this, "Y0", Blockly.Arduino.ORDER_ATOMIC) || "0",
        c = Blockly.Arduino.valueToCode(this, "X1", Blockly.Arduino.ORDER_ATOMIC) || "0",
        d = Blockly.Arduino.valueToCode(this, "Y1", Blockly.Arduino.ORDER_ATOMIC) || "0",
        e = this.getFieldValue("COLOR");
    return "matrix.drawRect(" + a + "," + b + "," + c + "," + d + "," + e + ");\n"
};
Blockly.Arduino.i2c_matrix_drawline = function() {
    var a = Blockly.Arduino.valueToCode(this, "X0", Blockly.Arduino.ORDER_ATOMIC) || "0",
        ...
        d = Blockly.Arduino.valueToCode(this, "Y1", Blockly.Arduino.ORDER_ATOMIC) || "0",
        e = this.getFieldValue("COLOR");
    return "matrix.drawLine(" + a + "," + b + "," + c + "," + d + "," + e + ");\n"
};
Blockly.Arduino.i2c_matrix_fillrect = function() {
    var a = Blockly.Arduino.valueToCode(this, "X0", Blockly.Arduino.ORDER_ATOMIC) || "0",
        ...
        d = Blockly.Arduino.valueToCode(this, "Y1", Blockly.Arduino.ORDER_ATOMIC) || "0",
        e = this.getFieldValue("COLOR");
    return "matrix.fillRect(" + a + "," + b + "," + c + "," + d + "," + e + ");\n"
};
Blockly.Arduino.i2c_matrix_setrotation = function() {
    return "matrix.setRotation(" + this.getFieldValue("ANGLE") + ");\n"
};
Blockly.Arduino.i2c_matrix_writedisplay = function() {
    return "matrix.writeDisplay();\n"
};
Blockly.Arduino.i2c_matrix_writedigitnum = function() {
    var a = this.getFieldValue("POSITION"),
        b = Blockly.Arduino.valueToCode(this, "NUM", Blockly.Arduino.ORDER_ATOMIC) || "0",
        c = Blockly.Arduino.valueToCode(this, "DOTS", Blockly.Arduino.ORDER_NONE) || "false";
    return "matrix.writeDigitNum(" + a + "," + b + "," + c + ");\n"
};
Blockly.Arduino.i2c_matrix_drawcolon = function() {
    return "matrix.drawColon(" + (Blockly.Arduino.valueToCode(this, "DOTS", Blockly.Arduino.ORDER_NONE) || "false") + ");\n"
};
Blockly.Arduino.cast = {};
Blockly.Arduino.cast_number = function() {
    var a = this.getFieldValue("TYPE"),
        b = Blockly.Arduino.valueToCode(this, "VAR", Blockly.Arduino.ORDER_ATOMIC) || "0";
    return [a + " " + b, Blockly.Arduino.ORDER_ATOMIC]
};
// Copyright 2012 Google Inc.  Apache License 2.0
Blockly.Arduino.shield_bot = {};
Blockly.Arduino.shield_bot_setmaxspeed = function() {
    var a = this.getFieldValue("SPEED");
    a = a.replace(/[(|)]/g, "");
    255 < a ? a = 255 : 0 > a && (a = 0);
...
Blockly.Arduino.shield_bot_setmaxspeed_lr = function() {
    var a = this.getFieldValue("LEFT"),
        b = this.getFieldValue("RIGHT");
    a = a.replace(/[(|)]/g, "");
    b = b.replace(/[(|)]/g, "");
    255 < a ? a = 255 : 0 > a && (a = 0);
    255 < b ? b = 255 : 0 > b && (b = 0);
...
Blockly.Arduino.shield_bot_motor = function() {
    var a = this.getFieldValue("RL"),
        b = Blockly.Arduino.valueToCode(this, "DIRECTION", Blockly.Arduino.ORDER_ATOMIC) || "0";
    b = b.replace(/[(|)]/g, "");
    127 < b ? b = 127 : -128 > b && (b = -128);
    Blockly.Arduino.definitions_.include_shield_bot = "#include <Shieldbot.h>";
    Blockly.Arduino.definitions_.define_shield_bot = "Shieldbot shieldbot = Shieldbot();\n";
    return "shieldbot." + a + "(" + String(b) + ");\n"
};
Blockly.Arduino.shield_bot_move = function() {
    var a = this.getFieldValue("MOVE");
    Blockly.Arduino.definitions_.include_shield_bot = "#include <Shieldbot.h>";
    Blockly.Arduino.definitions_.define_shield_bot = "Shieldbot shieldbot = Shieldbot();\n";
    return "shieldbot." + a + "();\n"
};
Blockly.Arduino.shield_bot_drive = function() {
    var a = Blockly.Arduino.valueToCode(this, "LEFT", Blockly.Arduino.ORDER_ATOMIC) || "127",
        b = Blockly.Arduino.valueToCode(this, "RIGHT", Blockly.Arduino.ORDER_ATOMIC) || "127";
    a = a.replace(/[(|)]/g, "");
    b = b.replace(/[(|)]/g, "");
    127 < a ? a = 127 : -128 > a && (a = -128);
    127 < b ? b = 127 : -128 > b && (b = -128);
    Blockly.Arduino.definitions_.include_shield_bot = "#include <Shieldbot.h>";
    Blockly.Arduino.definitions_.define_shield_bot = "Shieldbot shieldbot = Shieldbot();\n";
...
Blockly.Arduino.shield_bot_readsensor = function() {
    ...
    Blockly.Arduino.definitions_.include_shield_bot = "#include <Shieldbot.h>";
    Blockly.Arduino.definitions_.define_shield_bot = "Shieldbot shieldbot = Shieldbot();\n";
    return ["shieldbot.readS" + a + "()", Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Arduino.ultrasonic_maxrange = function() {
    var a = this.getFieldValue("UNIT"),
        b = this.getFieldValue("MAXRANGE");
    Blockly.Arduino.definitions_.define_sonic_timeout = "CM" == a ? "int Sonic_Time_out = " + b + "*2*29;\n" : "int Sonic_Time_out = " + b + "*2*72;\n";
    return ""
};
Blockly.Arduino.ultrasonic_distance = function() {
    return ["CM" == this.getFieldValue("UNIT") ? "Sonic_Timing()/29/2" : "Sonic_Timing()/74/2", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.lcd = {};
Blockly.Arduino.lcd_init = function() {
    var a = this.getFieldValue("RS"),
...
Blockly.Arduino.servo_attach = function() {
    ...
    void 0 === Blockly.Arduino.setups_["servo_" + a] ? Blockly.Arduino.setups_["servo_" + a] = "__myservo" + a + ".attach(" + a + ");" : b = "__myservo" + a + ".attach(" + a + ");\n";
    return b
};
...
Blockly.Arduino.servo_attached = function() {
    ...
    Blockly.Arduino.definitions_["define_class_servo_" + a] = "Servo __myservo" + a + ";";
    void 0 === Blockly.Arduino.setups_["servo_" + a] && (Blockly.Arduino.setups_["servo_" + a] = "__myservo" + a + ".attach(" + a + ");");
    return ["__myservo" + a + ".attached()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.servo_detach = function() {
    var a = this.getFieldValue("PIN");
    Blockly.Arduino.definitions_.define_servo = "#include <Servo.h>";
    Blockly.Arduino.definitions_["define_class_servo_" + a] = "Servo __myservo" + a + ";";
    return "__myservo" + a + ".detach();\n"
};
Blockly.Arduino.ir_remote = {};
Blockly.Arduino.ir_remote_get = function(a) {
    a = a.getFieldValue("PIN");
...
Blockly.Arduino.ir_remote_button = function(a) {
    return [a.getFieldValue("BUTTON"), Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.m2x = {};
Blockly.Arduino.m2x_begin = function() {
    var a = this.getFieldValue("VERSION"),
        ...
        c = Blockly.Arduino.valueToCode(this, "STREAM_NAME", Blockly.Arduino.ORDER_ATOMIC) || "",
        d = Blockly.Arduino.valueToCode(this, "KEY", Blockly.Arduino.ORDER_ATOMIC) || "";
    Blockly.Arduino.definitions_.define_spi = "#include <SPI.h>";
    Blockly.Arduino.definitions_.define_ethernet = "#include <Ethernet" + a + ".h>";
    ...
    Blockly.Arduino.definitions_.define_m2x_id = "char m2xId[] = " + b + ";";
    Blockly.Arduino.definitions_.define_m2x_stream_name = "char m2xStream[] = " + c + ";";
    Blockly.Arduino.definitions_.define_m2x_key = "char m2xKey[] = " + d + ";";
...
Blockly.Arduino.m2x_update_value = function() {
    return ["m2xClient.updateStreamValue(m2xId, m2xStream, " + (Blockly.Arduino.valueToCode(this, "VALUE", Blockly.Arduino.ORDER_ATOMIC) || "0") + ")", Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Arduino.m2x_custom_list_value = function() {
    var a = this.getFieldValue("DATE0"),
        b = this.getFieldValue("HOUR0"),
        c = this.getFieldValue("MIN0"),
        d = this.getFieldValue("SEC0"),
        e = this.getFieldValue("DATE1"),
        f = this.getFieldValue("HOUR1"),
        g = this.getFieldValue("MIN1"),
        h = this.getFieldValue("SEC1");
    Blockly.Arduino.setups_["setup_serial_" + profile["default"].serial] = "Serial.begin(" + profile["default"].serial + ");\n";
    Blockly.Arduino.definitions_.define_on_data_point_found = 'void on_data_point_found(const char* at, const char* value, int index, void* context, int type) {\n  Serial.print("Found a data point, index:");\n  Serial.println(index);\n  Serial.print("Type:");\n  Serial.println(type);\n  Serial.print("At:");\n  Serial.println(at);\n  Serial.print("Value:");\n  Serial.println(value);\n}\n';
...
Blockly.Arduino.m2x_delete_values = function() {
    var a = this.getFieldValue("DATE0"),
        ...
        g = this.getFieldValue("MIN1"),
        h = this.getFieldValue("SEC1");
    return ['m2xClient.deleteValues(m2xId, m2xStream, "' + a + "T" + b + ":" + c + ":" + d + 'Z","' + e + "T" + f + ":" + g + ":" + h + 'Z")', Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.m2x_update_location = function() {
    var a = Blockly.Arduino.valueToCode(this, "LOCATION_NAME", Blockly.Arduino.ORDER_ATOMIC) || "0",
        b = Blockly.Arduino.valueToCode(this, "LATITUDE", Blockly.Arduino.ORDER_ATOMIC) || "0",
        c = Blockly.Arduino.valueToCode(this, "LONGITUDE", Blockly.Arduino.ORDER_ATOMIC) || "0",
        d = Blockly.Arduino.valueToCode(this, "ELEVATION", Blockly.Arduino.ORDER_ATOMIC) || "0";
    return ["m2xClient.updateLocation(m2xId, " + a + ", (double)" + b + ", (double)" + c + ", (double)" + d + ")", Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Arduino.otto_init = function() {
    var a = this.getFieldValue("YL"),
        b = this.getFieldValue("YR"),
        c = this.getFieldValue("RL"),
        d = this.getFieldValue("RR");
...
Blockly.Arduino.otto_calibrate = function() {
    ...
    Blockly.Arduino.definitions_.define_define_otto_trim_yl =
        "#define OTTO_TRIM_LEFT_LEG " + a;
    Blockly.Arduino.definitions_.define_define_otto_trim_yr = "#define OTTO_TRIM_RIGHT_LEG " + b;
    Blockly.Arduino.definitions_.define_define_otto_trim_rl = "#define OTTO_TRIM_LEFT_FOOT " + c;
    Blockly.Arduino.definitions_.define_define_otto_trim_rr = "#define OTTO_TRIM_RIGHT_FOOT " + d;
    "setup_otto_init" in Blockly.Arduino.setups_ && (Blockly.Arduino.setups_.setup_otto_init = "__otto.initLegs(OTTO_PIN_LEFT_LEG, OTTO_PIN_RIGHT_LEG, OTTO_PIN_LEFT_FOOT, OTTO_PIN_RIGHT_FOOT, true);");
    Blockly.Arduino.setups_.setup_otto_trim =
...
Blockly.Arduino.otto_walk = function() {
    var a = this.getFieldValue("DIRECTION"),
        b = Blockly.Arduino.valueToCode(this, "DISTANCE", Blockly.Arduino.ORDER_ATOMIC) || 4,
        c = Blockly.Arduino.valueToCode(this, "DURATION", Blockly.Arduino.ORDER_ATOMIC) || 1E3;
    Blockly.Arduino.definitions_.define_include_otto = "#include <Otto.h>\n";
    Blockly.Arduino.definitions_.define_define_otto_item = "Otto __otto;\n";
...
Blockly.Arduino.otto_bend = function() {
    var a = this.getFieldValue("DIRECTION"),
        b = Blockly.Arduino.valueToCode(this, "DISTANCE", Blockly.Arduino.ORDER_ATOMIC) || 1,
        c = Blockly.Arduino.valueToCode(this, "DURATION", Blockly.Arduino.ORDER_ATOMIC) || 1400;
    Blockly.Arduino.definitions_.define_include_otto = "#include <Otto.h>\n";
    Blockly.Arduino.definitions_.define_define_otto_item = "Otto __otto;\n";
...
Blockly.Arduino.otto_shake_leg = function() {
    var a = this.getFieldValue("DIRECTION"),
        b = Blockly.Arduino.valueToCode(this, "DISTANCE", Blockly.Arduino.ORDER_ATOMIC) || 1,
        c = Blockly.Arduino.valueToCode(this, "DURATION", Blockly.Arduino.ORDER_ATOMIC) || 2E3;
    Blockly.Arduino.definitions_.define_include_otto = "#include <Otto.h>\n";
    Blockly.Arduino.definitions_.define_define_otto_item = "Otto __otto;\n";
    return "__otto.shakeLeg(" + b + ", " + c + ", " + a + ");\n"
};
Blockly.Arduino.otto_freestyle = function() {
    var a = this.getFieldValue("STYLE"),
        b = Blockly.Arduino.valueToCode(this, "DISTANCE", Blockly.Arduino.ORDER_ATOMIC) || 1,
        c = Blockly.Arduino.valueToCode(this, "DURATION", Blockly.Arduino.ORDER_ATOMIC) || 1E3,
        d = Blockly.Arduino.valueToCode(this, "HEIGHT", Blockly.Arduino.ORDER_ATOMIC) || 20;
    Blockly.Arduino.definitions_.define_include_otto = "#include <Otto.h>\n";
    Blockly.Arduino.definitions_.define_define_otto_item = "Otto __otto;\n";
...
Blockly.Arduino.otto_height = function() {
    return [this.getFieldValue("HEIGHT"), Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.otto_ultrasonic_init = function() {
    ...
    Blockly.Arduino.setups_.setup_otto_ultrasonic_init =
...
Blockly.Arduino.otto_buzzer_init = function() {
    ...
    Blockly.Arduino.definitions_.define_include_otto = "#include <Otto.h>\n";
    Blockly.Arduino.definitions_.define_define_otto_item = "Otto __otto;\n";
    Blockly.Arduino.definitions_.define_define_otto_buzzer_init = "#define OTTO_PIN_BUZZER " + a;
...
Blockly.Arduino.otto_led_matrix_init = function() {
    var a = this.getFieldValue("DIN"),
        b = this.getFieldValue("CS"),
        c = this.getFieldValue("CLK"),
        d = this.getFieldValue("DIR");
    Blockly.Arduino.definitions_.define_include_otto = "#include <Otto.h>\n";
    Blockly.Arduino.definitions_.define_define_otto_item = "Otto __otto;\n";
    Blockly.Arduino.definitions_.define_define_otto_led_matrix_init_din = "#define OTTO_PIN_LED_DIN " + a;
    Blockly.Arduino.definitions_.define_define_otto_led_matrix_init_din = "#define OTTO_PIN_LED_CS_PIN " +
        b;
    Blockly.Arduino.definitions_.define_define_otto_led_matrix_init_din = "#define OTTO_PIN_LED_CLK_PIN " + c;
    Blockly.Arduino.setups_.setup_otto_led_matrix_init = "__otto.initLEDMatrix(OTTO_PIN_LED_DIN, OTTO_PIN_LED_CS_PIN, " + d + ");";
    return ""
};
Blockly.Arduino.array = {};
Blockly.Arduino.array_create_with = function() {
    for (var a = Array(this.itemCount_), b = 0; b < this.itemCount_; b++) a[b] = Blockly.Arduino.valueToCode(this, "ADD" + b, Blockly.Arduino.ORDER_COMMA) || "null";
    a = "{" + a.join(", ") + "}";
    return [a, Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.array_getIndex = function() {
    var a = Blockly.Arduino.valueToCode(this, "AT", Blockly.Arduino.ORDER_UNARY_NEGATION) || "1",
        b = Blockly.Arduino.valueToCode(this, "ITEM", Blockly.Arduino.ORDER_MEMBER) || "[]";
    Blockly.isNumber(a) && (a = parseFloat(a) - 1);
...
Blockly.Arduino.interrupts_attach = function() {
    var a = this.getFieldValue("PIN"),
        ...
        c = Blockly.Arduino.statementToCode(this, "CONTENT");
...
Blockly.Arduino.mpr121_touched = function() {
    var a = Blockly.Arduino.valueToCode(this, "CH", Blockly.Arduino.ORDER_ATOMIC) || "0";
    Blockly.Arduino.definitions_.define_wire = "#include <Wire.h>";
    Blockly.Arduino.definitions_.define_mpr121 = "#include <Adafruit_MPR121.h>\nAdafruit_MPR121 cap = Adafruit_MPR121();\nuint16_t lasttouched = 0;\nuint16_t currtouched = 0;";
    Blockly.Arduino.setups_.setup_cap_begin = "cap.begin(0x5A);\n";
...
Blockly.Arduino.blynk_ethernet_begin = function() {
    this.getFieldValue("VERSION");
    var a = Blockly.Arduino.valueToCode(this, "AUTH", Blockly.Arduino.ORDER_ATOMIC) || "",
        b = Blockly.Arduino.valueToCode(this, "MAC_ADDRESS", Blockly.Arduino.ORDER_ATOMIC) || "0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0xED";
    b = b.replace(/"/g, "");
    Blockly.Arduino.definitions_.define_spi = "#include <SPI.h>";
...
Blockly.Arduino.blynk_write = function() {
    var a = this.getFieldValue("PIN"),
        b = Blockly.Arduino.statementToCode(this, "ACTION");
    Blockly.Arduino.definitions_["define_blynk_virtual_" + a] = "BLYNK_WRITE(V" + a + ")\n{\n" + b + "}\n";
    return ""
};
Blockly.Arduino.blynk_param = function() {
    return ["param." + this.getFieldValue("TYPE") + "()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.blynk_merge_param = function() {
    var a = this.getFieldValue("INDEX"),
        b = this.getFieldValue("TYPE");
    return ["param[" + a + "]." + b + "()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.blynk_virtual_write = function() {
    var a = this.getFieldValue("PIN"),
        b = Blockly.Arduino.valueToCode(this, "VALUE", Blockly.Arduino.ORDER_ATOMIC) || "0";
    return "Blynk.virtualWrite(V" + a + ", " + b + ");\n"
};
Blockly.Arduino.blynk_email = function() {
    var a = Blockly.Arduino.valueToCode(this, "ADDRESS", Blockly.Arduino.ORDER_ATOMIC) || "",
        b = Blockly.Arduino.valueToCode(this, "TITLE", Blockly.Arduino.ORDER_ATOMIC) || "",
        c = Blockly.Arduino.valueToCode(this, "BODY", Blockly.Arduino.ORDER_ATOMIC) || "";
    return "Blynk.email(" + a + ", " + b + ", " + c + ");\n"
};
Blockly.Arduino.blynk_notify = function() {
    return "Blynk.notify(" + (Blockly.Arduino.valueToCode(this, "TEXT", Blockly.Arduino.ORDER_ATOMIC) || "") + ");\n"
};
Blockly.Arduino.blynk_tweet = function() {
    return "Blynk.tweet(" + (Blockly.Arduino.valueToCode(this, "TEXT", Blockly.Arduino.ORDER_ATOMIC) || "") + ");\n"
};
Blockly.Arduino.blynk_connect = function() {
    return ["Blynk.connect()", Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Arduino.math_map_int = function() {
    var a = Blockly.Arduino.valueToCode(this, "VALUE", Blockly.Arduino.ORDER_NONE),
        b = this.getFieldValue("FROMLOW") || "0",
        c = this.getFieldValue("FROMHIGH") || "1024",
        d = this.getFieldValue("TOLOW") || "0",
        e = this.getFieldValue("TOHIGH") || "255";
    return ["map(" + a + "," + b + "," + c + "," + d + "," + e + ")", Blockly.Arduino.ORDER_NONE]
};
Blockly.Arduino.math_map_float = function() {
    Blockly.Arduino.definitions_.mapFloat = "float mapFloat(float x, float in_min, float in_max, float out_min, float out_max) {\n  return (x - in_min) * (out_max - out_min) / (in_max - in_min) + out_min;\n}\n";
    var a = Blockly.Arduino.valueToCode(this, "VALUE", Blockly.Arduino.ORDER_NONE),
        b = this.getFieldValue("FROMLOW") || "0",
        c = this.getFieldValue("FROMHIGH") || "1024",
        d = this.getFieldValue("TOLOW") || "0",
        e = this.getFieldValue("TOHIGH") || "255";
    return ["mapFloat(" + a + "," + b + "," +
        c + "," + d + "," + e + ")", Blockly.Arduino.ORDER_NONE
    ]
};
...
Blockly.Arduino.math_pow = function(a) {
    var b = Blockly.Arduino.valueToCode(a, "base", Blockly.Arduino.ORDER_NONE) || "1";
    a = Blockly.Arduino.valueToCode(a, "exp", Blockly.Arduino.ORDER_NONE) || "1";
    return ["pow(" + b + ", " + a + ")", Blockly.Arduino.ORDER_NONE]
};
Blockly.Arduino.math_single = function(a) {
    var b = a.getFieldValue("OP");
    a = Blockly.Arduino.valueToCode(a, "NUM", Blockly.Arduino.ORDER_NONE) || "1";
    switch (b) {
        case "ABS":
            var c = "abs(" + a + ")";
            break;
    ...
    return [c, Blockly.Arduino.ORDER_NONE]
};
Blockly.Arduino.math_degree_to_radian = function(a) {
    Blockly.Arduino.definitions_.const_pi = "const float __MPI = " + Math.PI + ";";
    Blockly.Arduino.definitions_.radiansFromDegree = "\nfloat __radiansFromDegree(float degrees) {\n  return degrees / 360 * 2 * __MPI;\n}\n";
    a = Blockly.Arduino.valueToCode(a, "DEGREE", Blockly.Arduino.ORDER_NONE) || 0;
    console.log(Math.PI);
    return ["__radiansFromDegree(" + a + ")", Blockly.Arduino.ORDER_NONE]
};
Blockly.Arduino.ifttt = {};
Blockly.Arduino.ifttt_get_url = function() {
    var a = Array(3),
        b = Blockly.Arduino.valueToCode(this, "EVENT", Blockly.Arduino.ORDER_ATOMIC) || "",
        c = Blockly.Arduino.valueToCode(this, "KEY", Blockly.Arduino.ORDER_ATOMIC) || "";
    a[0] = Blockly.Arduino.valueToCode(this, "VALUE1", Blockly.Arduino.ORDER_ATOMIC) || "";
    a[1] = Blockly.Arduino.valueToCode(this, "VALUE2", Blockly.Arduino.ORDER_ATOMIC) || "";
    a[2] = Blockly.Arduino.valueToCode(this, "VALUE3", Blockly.Arduino.ORDER_ATOMIC) || "";
    b = b.replace(/\"/g, "");
    c = c.replace(/\"/g, "");
    b = "/trigger/" +
        b + "/with/key/" + c;
    for (var d = c = 0; 3 > d; d++) 0 < a[d].length && (0 == c ? (b += "?", c = 1) : 1 == c && (b += "&"), b += "value" + (d + 1) + "=" + a[d]);
...
Blockly.Arduino.pulsein = function() {
    var a = this.getFieldValue("pin"),
        b = Blockly.Arduino.valueToCode(this, "timeout", Blockly.Arduino.ORDER_ATOMIC) || "-1",
        c = "HIGH" == this.getFieldValue("type") ? "HIGH" : "LOW";
    console.log(b);
    Blockly.Arduino.setups_["setup_output_" + a] = "pinMode(" + a + ", INPUT);";
    return [0 < b ? "pulseIn(" + a + "," + c + "," + b + ")" : "pulseIn(" + a + "," + c + ")", Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Arduino.dht_read = function() {
    ...
    switch (this.getFieldValue("TYPE")) {
        case "h":
            c += "(int)(dht_" + b + "_" + a + ".readHumidity())";
            break;
        case "C":
            c += "(int)(dht_" + b + "_" + a + ".readTemperature())";
            break;
        case "F":
            c += "(int)(dht_" + b + "_" + a + ".readTemperature(true))"
    }
...
Blockly.Arduino.inout_custom_digital_write = function() {
    var a = Blockly.Arduino.valueToCode(this, "PIN", Blockly.Arduino.ORDER_ATOMIC) || "13",
...
Blockly.Arduino.inout_custom_analog_write = function() {
    var a = Blockly.Arduino.valueToCode(this, "PIN_ANALOGWRITE", Blockly.Arduino.ORDER_ATOMIC),
        b = Blockly.Arduino.valueToCode(this, "NUM", Blockly.Arduino.ORDER_ATOMIC) || "255";
    Blockly.Arduino.setups_["setup_output_" + a] = "pinMode(" + a + ", OUTPUT);";
    return "analogWrite(" + a + ", " + b + ");\n"
};
...
Blockly.Arduino.inout_analogpin = function() {
    return [this.getFieldValue("PIN"), Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.linkit = {};
var controlch;
Blockly.Arduino.linkit_ble_periphral_is_written = function() {
    var a = Blockly.Arduino.valueToCode(this, "CHARACTERISTIC", Blockly.Arduino.ORDER_ATOMIC) || "";
    this.getFieldValue("TYPE");
    a = a.replace(/\"/g, "");
    a = a.replace(/-/g, "_");
    a = a.toLowerCase();
    return ["__" + a + ".isWritten()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.linkit_ble_periphral_write = function() {
    ...
    a = a.replace(/-/g, "_");
    a = a.toLowerCase();
    return ("int" == c ? "__" + a + ".setValue(" + b + ");" : "__" + a + '.setValue("' + b + '");') + "\n"
};
Blockly.Arduino.linkit_ble_periphral_get_value = function() {
    ...
    a = a.replace(/-/g, "_");
    a = a.toLowerCase();
    return ["__" + a + ".getValue()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.linkit_ble_Characteristic = function() {
    var a = Blockly.Arduino.valueToCode(this, "CHARACTERISTIC", Blockly.Arduino.ORDER_ATOMIC) || "",
        b = this.getFieldValue("TYPE"),
        c = this.getFieldValue("CHARACTERISTIC_TYPE");
    a = a.replace(/\"/g, "");
    var d = a.replace(/-/g, "_");
    d = d.toLowerCase();
    ...
    Blockly.Arduino.definitions_["define_linkit_ble_periphral_include_characteristic" +
        d] = "" + c + " __" + d + '("' + a + '", ' + b + ");";
    Blockly.Arduino.setups_["define_linkit_ble_periphral__service_config" + d] = "__periphralService.addAttribute(__" + d + ");";
    return "\n"
};
Blockly.Arduino.linkit_ble_eddy = function() {
    var a = Blockly.Arduino.valueToCode(this, "URL", Blockly.Arduino.ORDER_ATOMIC) || "";
    this.getFieldValue("TYPE");
    a = a.replace(/\"/g, "");
    if (11 > a.length || !a.startsWith("http://") && !a.startsWith("https://")) return "// " + Blockly.Msg.LINKIT_SET_BLE_PERIPHRAL_EDDY_URL_INVALID;
    if (a.startsWith("http://")) {
        var b = "EDDY_HTTP";
        a = a.substring(7)
    } else b = "EDDY_HTTPS", a = a.substring(8);
    17 < a.length && (a = a.substring(0, 17));
    Blockly.Arduino.definitions_.define_linkit_ble_include = "#include <LBLE.h>";
    Blockly.Arduino.definitions_.define_linkit_ble_periphral_include = "#include <LBLEPeriphral.h>";
    ...
    Blockly.Arduino.setups_.define_linkit_ble_beacon_config_setup = "__beaconData.configAsEddystoneURL(" + b + ', "' + a + '");';
    Blockly.Arduino.setups_.define_linkit_ble_beacon_advertisement_advertise =
...
Blockly.Arduino.linkit_ble_periphral = function() {
    var a = Blockly.Arduino.valueToCode(this, "NAME", Blockly.Arduino.ORDER_ATOMIC) || "",
        b = Blockly.Arduino.valueToCode(this, "SERVICE", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    b = b.replace(/\"/g, "");
    Blockly.Arduino.definitions_.define_linkit_ble_include = "#include <LBLE.h>";
    Blockly.Arduino.definitions_.define_linkit_ble_periphral_include = "#include <LBLEPeriphral.h>";
    Blockly.Arduino.definitions_.define_linkit_ble_periphral_include_service = 'LBLEService __periphralService("' +
        b + '");';
    Blockly.Arduino.setups_.define_linkit_ble_setup = "LBLE.begin();";
    Blockly.Arduino.setups_.define_linkit_ble_setup_wait_loop = "while (!LBLE.ready()) { delay(100); }\n";
    b = Blockly.Arduino.statementToCode(this, "BLE_CONTENT");
    b = b.replace(/(^\s+)|(\s+$)/g, "");
    Blockly.Arduino.setups_.define_linkit_ble_periphral_service_config = b;
    Blockly.Arduino.setups_.define_linkit_ble_periphral_config = "LBLEPeripheral.addService(__periphralService);";
    Blockly.Arduino.setups_.define_linkit_ble_periphral_advertisement_name_set =
        'LBLEPeripheral.setName("' + a + '");';
    ...
    Blockly.Arduino.setups_.define_linkit_ble_periphral_advertisement_name_setup = '__advertisement.configAsConnectableDevice("' + a + '");';
...
Blockly.Arduino.linkit_ble_central_get_peripheral_with_index = function() {
    var a = Blockly.Arduino.valueToCode(this, "INDEX", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    Blockly.Arduino.definitions_.define_linkit_ble_include = "#include <LBLE.h>";
    ...
    return ["__scanner.getName(" + a + ")", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.linkit_ble_central_scan_count = function() {
    ...
    Blockly.Arduino.setups_.define_linkit_ble_setup_wait_loop = "while (!LBLE.ready()) { delay(100); }\n";
    Blockly.Arduino.setups_.define_linkit_ble_setup_central_scan = "LBLECentral.scan();";
    return ["LBLECentral.getPeripheralCount()",
        Blockly.Arduino.ORDER_ATOMIC
    ]
};
...
Blockly.Arduino.linkit_ble_ibeacon = function() {
    var a = Blockly.Arduino.valueToCode(this, "UUID", Blockly.Arduino.ORDER_ATOMIC) || "",
        b = Blockly.Arduino.valueToCode(this, "MAJOR", Blockly.Arduino.ORDER_ATOMIC) || "",
        c = Blockly.Arduino.valueToCode(this, "MINOR", Blockly.Arduino.ORDER_ATOMIC) || "",
        d = Blockly.Arduino.valueToCode(this, "RSSI", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    b = b.replace(/\"/g, "");
    c = c.replace(/\"/g, "");
    d = d.replace(/\"/g, "");
    ...
    Blockly.Arduino.setups_.define_linkit_ble_setup = "LBLE.begin();";
    Blockly.Arduino.setups_.define_linkit_ble_setup_wait_loop = "while (!LBLE.ready()) { delay(100); }\n";
    Blockly.Arduino.setups_.define_linkit_ble_ibeacon_config = '__beaconData.configAsIBeacon("' + a + '", ' + b + ", " + c + ", " + d + ");";
    Blockly.Arduino.setups_.define_linkit_ble_ibeacon_advertise =
        "LBLEPeripheral.advertise(__beaconData);";
    return "\n"
};
...
Blockly.Arduino.linkit_ble_get_address = function() {
    Blockly.Arduino.definitions_.define_linkit_ble_include = "#include <LBLE.h>";
    Blockly.Arduino.setups_.define_linkit_ble_setup = "LBLE.begin();";
    return ["LBLE.getDeviceAddress()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.linkit_ble_ready = function() {
    Blockly.Arduino.definitions_.define_linkit_ble_include = "#include <LBLE.h>";
    Blockly.Arduino.setups_.define_linkit_ble_setup = "LBLE.begin();";
    return ["LBLE.ready()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.mcs = function() {
    var a = Blockly.Arduino.valueToCode(this, "DEVICEID", Blockly.Arduino.ORDER_ATOMIC) || "",
        b = Blockly.Arduino.valueToCode(this, "DEVICEKEY", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    b = b.replace(/\"/g, "");
    ...
    a = Blockly.Arduino.statementToCode(this, "CONTENT");
    a = a.replace(/(^\s+)|(\s+$)/g, "");
    return a + "while(!mcs.connected()) { mcs.connect(); }\n"
};
Blockly.Arduino.mcs_set_control_channel = function() {
    var a = Blockly.Arduino.valueToCode(this, "CONTROL_CHANNEL", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    var b = this.getFieldValue("TYPE");
    Blockly.Arduino.setups_["mcs_add_channel" + a] = "mcs.addChannel(" + a + ");";
    Blockly.Arduino.definitions_["set_MCS_control" + a] = "boolean" == b ? "MCSControllerOnOff " + a + '("' + a + '");' : "category" == b ? "MCSControllerCategory " + a + '("' + a + '");' : "float" == b ? "MCSControllerFloat " + a + '("' + a + '");' : "String" == b ? "MCSControllerString " +
        a + '("' + a + '");' : "MCSControllerInteger " + a + '("' + a + '");';
    return ""
};
Blockly.Arduino.mcs_set_display_channel = function() {
    var a = Blockly.Arduino.valueToCode(this, "DISPLAY_CHANNEL", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    Blockly.Arduino.setups_["mcs_add_channel" + a] = "mcs.addChannel(" + a + ");";
    var b = this.getFieldValue("TYPE");
    Blockly.Arduino.definitions_["set_MCS_display" + a] = "boolean" == b ? "MCSDisplayOnOff " + a + '("' + a + '");' : "category" == b ? "MCSDisplayCategory " + a + '("' + a + '");' : "float" == b ? "MCSDisplayFloat " + a + '("' + a + '");' : "String" == b ? "MCSDisplayString " + a + '("' + a +
        '");' : "MCSDisplayInteger " + a + '("' + a + '");';
    return ""
};
Blockly.Arduino.mcs_add_channel = function() {
    var a = Blockly.Arduino.valueToCode(this, "ADD_CHANNEL", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    Blockly.Arduino.setups_["mcs_add_channel" + a] = "mcs.addChannel(" + a + ");\n";
    return ""
};
Blockly.Arduino.mcs_connected = function() {
    return ["mcs.connected()", Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Arduino.mcs_channel_valid = function() {
    var a = Blockly.Arduino.valueToCode(this, "CHANNEL_VALID", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    return [a + ".valid()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.mcs_channel_value = function() {
    var a = Blockly.Arduino.valueToCode(this, "CHANNEL_VALUE", Blockly.Arduino.ORDER_ATOMIC) || "";
    controlch = a = a.replace(/\"/g, "");
    return [a + ".value()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.mcs_channel2_value = function() {
    var a = Blockly.Arduino.valueToCode(this, "CHANNEL2_VALUE", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    var b = Blockly.Arduino.valueToCode(this, "SET_VALUE", Blockly.Arduino.ORDER_ATOMIC) || "";
    b = b.replace(/\"/g, "");
    return a + ".set(" + b + ");\n"
};
Blockly.Arduino.mcs_process = function() {
    Blockly.Arduino.setups_.add_serialport = "Serial.begin(9600);";
    return 'while (!mcs.connected()) {\n  mcs.connect();\n  if (mcs.connected()) { Serial.println("MCS Reconnected."); }\n}\nmcs.process(100);\n'
};
Blockly.Arduino.mcs_channel_wait_until_read_value = function() {
    var a = Blockly.Arduino.valueToCode(this, "CHANNEL", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    Blockly.Arduino.setups_["mcs_channel_wait_until_read_value" + a] = "while(!" + a + ".valid()) { " + a + ".value(); }\n";
    return ""
};
Blockly.Arduino.mcs_channel_updated = function() {
    var a = Blockly.Arduino.valueToCode(this, "CHANNEL_UPDATED", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    return [a + ".updated()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.mcslite = function() {
    var a = Blockly.Arduino.valueToCode(this, "DEVICEIDL", Blockly.Arduino.ORDER_ATOMIC) || "",
        b = Blockly.Arduino.valueToCode(this, "DEVICEKEYL", Blockly.Arduino.ORDER_ATOMIC) || "",
        c = Blockly.Arduino.valueToCode(this, "SERV", Blockly.Arduino.ORDER_ATOMIC) || "",
        d = Blockly.Arduino.valueToCode(this, "PORT", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    b = b.replace(/\"/g, "");
    c = c.replace(/\"/g, "");
    Blockly.Arduino.definitions_.define_mcs_include2 = '#include "MCS.h"\n';
...
Blockly.Arduino.linkit_wifi_ready_advanced = function() {
    ...
    Blockly.Arduino.definitions_.define_linkit_wifi_ssid = 'char _lwifi_ssid[] = "' + a + '";';
    Blockly.Arduino.definitions_.define_linkit_wifi_pass = 'char _lwifi_pass[] = "' + b + '";';
    return ["(WiFi.begin(_lwifi_ssid, _lwifi_pass) == WL_CONNECTED)", Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Arduino.linkit_wifi_status = function() {
    return [this.getFieldValue("String"), Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Arduino.ethernet_begin_dhcp = function() {
    ...
    Blockly.Arduino.definitions_.define_ethernet_client = "EthernetClient client;";
    Blockly.Arduino.definitions_.define_arduino_mac = "byte mac[] = {" + b + "};\n";
    return ["Ethernet.begin(mac)", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.ethernet_mac_address = function() {
    var a = this.getFieldValue("MAC_ADDRESS_1"),
        b = this.getFieldValue("MAC_ADDRESS_2"),
        c = this.getFieldValue("MAC_ADDRESS_3"),
        d = this.getFieldValue("MAC_ADDRESS_4"),
        e = this.getFieldValue("MAC_ADDRESS_5"),
        f = this.getFieldValue("MAC_ADDRESS_6");
    return ["0x" + a + ", 0x" + b + ", 0x" + c + ", 0x" + d + ", 0x" + e + ", 0x" + f, Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.ethernet_localip = function() {
    return ["Ethernet.localIP()", Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Arduino.ethernet_connected = function() {
    return ["client.connected()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.ethernet_connect = function() {
    var a = Blockly.Arduino.valueToCode(this, "SERVER", Blockly.Arduino.ORDER_ATOMIC) || "",
        b = this.getFieldValue("PORT");
    return ["client.connect(" + a + "," + b + ")", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.ethernet_print = function() {
    return "client.print(" + (Blockly.Arduino.valueToCode(this, "TEXT", Blockly.Arduino.ORDER_ATOMIC) || "") + ");\n"
};
Blockly.Arduino.ethernet_println = function() {
    return "client.println(" + (Blockly.Arduino.valueToCode(this, "TEXT", Blockly.Arduino.ORDER_ATOMIC) || "") + ");\n"
};
Blockly.Arduino.ethernet_stop = function() {
    return "client.stop();\n"
};
Blockly.Arduino.ethernet_read = function() {
    return ["(char)client.read()", Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino.ethernet_get_request = function() {
    var a = Blockly.Arduino.valueToCode(this, "URL", Blockly.Arduino.ORDER_ATOMIC) || "",
        b = Blockly.Arduino.valueToCode(this, "SERVER", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    b = b.replace(/\"/g, "");
    a = 'client.println("GET ' + a + ' HTTP/1.1");\n' + ('client.println(F("Host: ' + b + '"));\n') + 'client.println(F("Connection: close"));\n';
    return a += "client.println();\n"
};
Blockly.Arduino.ethernet_post_request = function() {
    var a = Blockly.Arduino.valueToCode(this, "URL", Blockly.Arduino.ORDER_ATOMIC) || "",
        b = Blockly.Arduino.valueToCode(this, "SERVER", Blockly.Arduino.ORDER_ATOMIC) || "",
        c = Blockly.Arduino.valueToCode(this, "POST_DATA", Blockly.Arduino.ORDER_ATOMIC) || "";
    a = a.replace(/\"/g, "");
    b = b.replace(/\"/g, "");
    a = 'client.println("POST ' + a + ' HTTP/1.1");\n' + ('client.print(F("Host: ' + b + ");\n") + 'client.println(F("Connection: close"));\n';
...
Blockly.Arduino.text_length = function() {
    return [(Blockly.Arduino.valueToCode(this, "VALUE", Blockly.Arduino.ORDER_FUNCTION_CALL) || "''") + ".length()", Blockly.Arduino.ORDER_MEMBER]
};
Blockly.Arduino.text_charAt = function() {
    var a = Blockly.Arduino.valueToCode(this, "VALUE", Blockly.Arduino.ORDER_ATOMIC) || "",
        b = Blockly.Arduino.valueToCode(this, "INDEX", Blockly.Arduino.ORDER_ATOMIC) || 0;
    return [a + ".charAt(" + b + ")", Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Arduino.serial_byte_number = function() {
    return [this.getFieldValue("NUM"), Blockly.Arduino.ORDER_ATOMIC]
};
